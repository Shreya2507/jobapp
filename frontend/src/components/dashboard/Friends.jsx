                    ...
                    user.username !== 'Shreya' ?
                      (<div className='bg-white w-full h-full p-10 rounded-3xl shadow-md shadow-slate-400'>
                        <div className=' h-full w-full flex flex-col justify-between items-center'>
                          ...
                          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 1.02 }} className=' text-base xl:text-xl font-semibold rounded-lg px-4 py-2 text-white bg-[#e3441f]'>Remove Friend</motion.button>
                        </div>
                      </div>)
                      : ''
                  ))
